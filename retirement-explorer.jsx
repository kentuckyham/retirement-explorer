...
// ─────────────────────────────────────────────────────────────────────────────
const MC = {
  trials: 500,           // trials per success-rate check
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <button onClick={handleRunMC} disabled={mcRunning} style={{
                    ...
                    {mcRunning ? "Running simulation\u2026" : mcResults && !mcStale ? "Re-run Monte Carlo" : "Run Monte Carlo (500 trials)"}
                  </button>
                </div>
              </div>
              <p style={{ fontSize: 12, color: "#64748b", lineHeight: 1.6, marginBottom: 8 }}>
                ...
                {mcResults && !mcStale && mcView === "mc"
                  ? " Rates computed via Monte Carlo simulation (500 trials, 90% success, seeded PRNG)."
...
export default RetirementExplorer
