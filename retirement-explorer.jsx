          ...
          {activeTab === "methods" && <>
            ...
            <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: 8, overflow: "hidden" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr",
                ...
                <div>Strategy</div>
                <div style={{ textAlign: "right" }}>{mcResults && !mcStale ? "MC Safe Rate" : "Est. Safe Rate"}</div>
                  ...
                  <div key={m.id} style={{
                    ...
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontSize: 15, fontWeight: 800,
                        ...
                        {useMC && mcResults[m.id].capped ? `\u226515.0%` : `${mRate.toFixed(1)}%`}
                      </div>
                      {useMC
                        ? <div style={{ fontSize: 10, color: "#6ee7b7" }}>
                            {mcResults[m.id].capped ? "can\u2019t deplete" : `MC ${(mcResults[m.id].successRate * 100).toFixed(0)}% success`}
                          </div>
